...
export const config = {
  ...
  licensing: {
    ...
    maxSessionsPerLicense: 3, // Máximo de sessões simultâneas por licença
    features: {
      // Funcionalidades que podem ser controladas por licença
  ...
  whatsapp: {
    ...
    apiUrl: process.env.REACT_APP_WHATSAPP_URL || 'http://localhost:3000',
    syncInterval: 5000
  },
...
export const shouldBypassLicensing = (): boolean => {
  return config.development.bypassLicensing && isDevelopment();
};
